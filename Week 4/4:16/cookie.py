class Solution(object):
    def findContentChildren(g, s):
        ...
        for size in s:
            if size in sdict.keys():
                newValue = sdict[size] + 1
                sdict[size] = newValue
            else: 
                sdict[size] = 1
        ...
        for greed in g:
            ...
            if greed in sdict.keys():
                if sdict[greed] == 1:
                    sdict.pop(greed)
                    ans += 1
                else:
                    newValue = sdict[greed] - 1
                    sdict[greed] = newValue
                    ans += 1
            elif len(tempArr) > 0:
                if sdict[tempArr[0]] == 1:
                    sdict.pop(tempArr[0])
                    ans += 1
                else:
                    newValue = sdict[tempArr[0]] - 1
                    sdict[tempArr[0]] = newValue
                    ans += 1
            else:
                continue
        return ans
